...
module.exports = __webpack_require__(/*! /home/kitush/Documents/Web/real-estate-client/src/main.ts */"zUnb");
...
const _c0 = function () { return ["/lands", 1]; };
const _c1 = function () { return ["land"]; };
...
ListingComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ListingComponent, selectors: [["app-listing"]], decls: 78, vars: 4, consts: [[1, "position-relative", "overflow-hidden", "p-3", "p-md-5", "text-center", "bg-light", "topImg"], [1, "col-md-5", "p-lg-5", "mx-auto", "my-5"], [1, "display-4", "fw-normal", "text-danger"], [1, "lead", "fw-bold", "text-secondary"], ["href", "#search", 1, "btn", "btn-danger"], [1, "product-device", "shadow-sm", "d-none", "d-md-block"], [1, "product-device", "product-device-2", "shadow-sm", "d-none", "d-md-block"], ["id", "search", 1, "container"], [1, "row", "mt-3"], [1, "col-md-6", "mx-auto"], ["id", "search_form", "onsubmit", "return false", 1, "col-lg-auto", "mb-3", "mb-lg-0", "me-lg-3"], ["type", "search", "id", "search", "placeholder", "Enter location", 1, "form-control", "form-control-dark"], ["id", "search_error", 1, "form-text", "text-muted"], [1, "text-center", "mt-2"], ["type", "submit", 1, "btn", "btn-outline-danger", "me-2"], [1, "fas", "fa-search-location"], [1, "container"], [1, "text-danger", "text-center", "mt-4"], [1, "row"], [1, "col-md-4", "d-grid", "p-1", "mx-auto"], ["type", "button", "data-bs-toggle", "collapse", "data-bs-target", ".multi-collapse", "aria-expanded", "false", "aria-controls", "multiCollapseExample1 multiCollapseExample2 multiCollapseExample3", 1, "btn", "btn-outline-danger"], [1, "row", "my-3"], [1, "col-md-4"], ["id", "multiCollapseExample1", 1, "collapse", "multi-collapse"], [1, "card", "card-body"], [1, "text-danger"], ["id", "multiCollapseExample2", 1, "collapse", "multi-collapse"], ["id", "multiCollapseExample3", 1, "collapse", "multi-collapse"], ["id", "land", 1, "container"], [1, "card", "text-center", "mt-4", 2, "border", "none"], [1, "card-header", "bg-danger", "text-white"], [1, "h4"], [1, "card-body"], [1, "row", "row-cols-1", "row-cols-md-3", "g-4"], [1, "col"], [1, "card", "shadow", "h-100"], ["src", "../../assets/images/house4.jpg", "height", "300", "alt", "...", 1, "card-img-top"], [1, "card-body", "text-muted"], [1, "card-title"], [1, "fas", "fa-map-marker-alt"], [2, "list-style", "none"], [1, "card-text"], [1, "fas", "fa-sitemap"], [1, "fas", "fa-arrows-alt"], [1, "fas", "fa-dollar-sign"], [1, "btn", "btn-danger", "w-50", 3, "routerLink"], [1, "fas", "fa-angle-double-right"], [1, "btn", "btn-outline-danger", "rounded-circle", "mb-3", 3, "routerLink"]], template: function ListingComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](66, "\u00A0Size 0.05Ha");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](69, "\u00A0Dimension 100m by 500m");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](72, "\u00A0Price");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
class RegisterComponent {
    ...
    register() {
        ...
        this.auth.registerUser(this.registerData.value).subscribe((res) => {
...
RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: RegisterComponent, selectors: [["app-register"]], decls: 40, vars: 3, consts: [[1, "container", "mt-4"], [1, "card", "bg-light", "shadow", "col-md-10", "mx-auto"], [1, "card-header", "bg-light"], [1, "text-danger", "text-center"], [1, "card-body"], ["id", "signUp_form", 1, "row", "g-3", 3, "formGroup", "ngSubmit"], [1, "col-md-6"], [1, "form-label"], ["formControlName", "firstName", "type", "text", "id", "firstName", "placeholder", "John", 1, "form-control"], ["id", "firstName_error", 1, "form-text", "text-muted"], ["formControlName", "lastName", "type", "text", "id", "lastName", "placeholder", "Doe", 1, "form-control"], ["id", "lastName_error", 1, "form-text", "text-muted"], ["formControlName", "email", "type", "email", "id", "email", "placeholder", "email@email.com", 1, "form-control"], ["id", "email_error", 1, "form-text", "text-muted"], ["for", "inputAddress", 1, "form-label"], ["formControlName", "phoneNumber", "type", "text", "id", "phoneNumber", "placeholder", "+(254) 7-00-500-777", 1, "form-control"], ["id", "phoneNumber_error", 1, "form-text", "text-muted"], ["formControlName", "password", "type", "password", "id", "password", "placeholder", "************", 1, "form-control"], ["id", "password_error", 1, "form-text", "text-muted"], [1, "col-12"], ["type", "submit", 1, "btn", "btn-outline-danger"], [1, "card-footer", "bg-light"], [1, "text-muted"], [1, "text-danger", 3, "routerLink"]], template: function RegisterComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _app_counties_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../app/counties.json */ "7jBf");
var _app_counties_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../app/counties.json */ "7jBf", 1);
...
function SettingsComponent_option_50_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "option", 17);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function SettingsComponent_option_56_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "option", 17);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
} if (rf & 2) {
...
SettingsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: SettingsComponent, selectors: [["app-settings"]], decls: 90, vars: 3, consts: [[1, "container", "mt-3"], [1, "card"], [1, "card-header"], [1, "card-body"], [1, "row"], [1, "col"], ["type", "text", 1, "form-control"], ["type", "tel", 1, "form-control"], ["type", "email", 1, "form-control"], ["type", "submit", 1, "btn", "btn-danger", "btn-sm", "mt-3"], [1, "card", "mt-3"], [1, "font-weight-bold"], [1, "btn", "btn-danger", "btn-sm"], [1, "form-select"], [3, "value", 4, "ngFor", "ngForOf"], [1, "table"], ["scope", "row"], [3, "value"]], template: function SettingsComponent_Template(rf, ctx) { if (rf & 1) {
...
AboutComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AboutComponent, selectors: [["app-about"]], decls: 176, vars: 0, consts: [[1, "container"], [1, "card", "shadow", "my-3", "p-5", "bg-light"], [1, "card-body"], [1, "text-center", "text-danger", "py-3", 2, "font-size", "35px"], [1, "row", "g-0"], [1, "col-lg-6", "col-md-6", "col-sm-12", "col-12"], ["src", "../../assets/images/bg1.svg", "alt", "", 1, "img-fluid"], [1, "col-lg-6", "col-md-6", "col-sm-12", "col-12", "text-muted"], [1, "pt-5"], [1, "team"], [1, "m-3", "text-danger"], [1, "mx-auto", 2, "border", "2px solid rgb(160, 16, 16)", "border-radius", "5px", "max-width", "500px"], [1, "row", "justify-content-center"], [1, "col-md-3", "shadow", "mx-3", "my-3"], [1, "img-box"], ["src", "../../assets/images/ProfilePic.svg", 1, "img-responsive", 2, "width", "100px"], [1, "text-warning"], [1, "text-muted"], [1, "text-center"], ["href", "", 1, "text-primary"], [1, "fab", "fa-twitter"], [1, "fab", "fa-linkedin-in"], ["href", "", 1, "text-success", 2, "text-decoration", "none"], [1, "fab", "fa-whatsapp"], ["href", "", 2, "text-decoration", "none", "color", "#C13584"], [1, "fab", "fa-instagram"], [1, "fab", "fa-facebook-f"], [1, "text-danger"], [1, "newsletter", "p-2", "pt-md-2", "pb-md-4", "m-4"], [1, "row"], [1, "col-lg-7", "col-md-7", "col-sm-12", "col-xs-12", "mx-auto", "text-center"], [1, "input-group", "p-3"], ["type", "email", "placeholder", "Type your email address", 1, "form-control"], [1, "input-group-btn"], ["type", "submit", 1, "btn", "btn-danger"], [1, "col-md-2", "col-6"], ["src", "", "alt", "companies logo here", 1, "img-fluid", "feature-img", "p-2"]], template: function AboutComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
function RecoverPasswordComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function RecoverPasswordComponent_div_0_Template_form_ngSubmit_6_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r2.requestReset(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RecoverPasswordComponent_div_0_Template_input_ngModelChange_10_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r4.email = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
function RecoverPasswordComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "div", 5);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](6, "form", 6);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function RecoverPasswordComponent_div_1_Template_form_ngSubmit_6_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r5.changePassword(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](7, "div", 7);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "label", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](9, "Password");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](10, "input", 16);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RecoverPasswordComponent_div_1_Template_input_ngModelChange_10_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r7.newPassword = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
class RecoverPasswordComponent {
    ...
    requestReset() {
        this.auth.requestReset(this.email).subscribe((res) => {
            console.log(res);
        }, (err) => {
            console.log(err);
        });
...
RecoverPasswordComponent.ɵfac = function RecoverPasswordComponent_Factory(t) { return new (t || RecoverPasswordComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"])); };
RecoverPasswordComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RecoverPasswordComponent, selectors: [["app-recover-password"]], decls: 2, vars: 2, consts: [["class", "container mt-5 py-5", 4, "ngIf"], [1, "container", "mt-5", "py-5"], [1, "card", "bg-light", "shadow", "col-md-6", "mx-auto"], [1, "card-header", "bg-light"], [1, "text-danger", "text-center"], [1, "card-body"], ["id", "login_form", 1, "row", "g-3", 3, "ngSubmit"], [1, "col-md-12"], [1, "form-label"], ["type", "text", "name", "email", "id", "email", "placeholder", "email@email.com", 1, "form-control", 3, "ngModel", "ngModelChange"], ["id", "email_error", 1, "form-text", "text-muted"], [1, "col-12"], ["type", "submit", 1, "btn", "btn-outline-danger"], [1, "card-footer", "bg-light"], [1, "text-muted"], [1, "text-danger", 3, "routerLink"], ["name", "password", "type", "password", "id", "password", "placeholder", "*************", 1, "form-control", 3, "ngModel", "ngModelChange"], ["id", "password_error", 1, "form-text", "text-muted"], ["type", "password", "id", "confirm-password", "placeholder", "*************", 1, "form-control"], ["id", "confirm_password_error", 1, "form-text", "text-muted"]], template: function RecoverPasswordComponent_Template(rf, ctx) { if (rf & 1) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LandComponent", function() { return LandComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "tyNb");
...
const _c0 = function () { return ["/lands", 4]; };
class LandComponent {
    constructor() { }
    ngOnInit() {
        window.scrollTo(0, 0);
...
LandComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LandComponent, selectors: [["app-land"]], decls: 60, vars: 2, consts: [[1, "position-relative", "overflow-hidden", "p-3", "p-md-5", "m-md-3", "text-center", "bg-light", "topImg"], [1, "col-md-5", "p-lg-5", "mx-auto", "my-5"], [1, "display-4", "fw-normal", "text-danger"], [1, "lead", "fw-bold", "text-secondary"], ["href", "#search", 1, "btn", "btn-danger"], [1, "product-device", "shadow-sm", "d-none", "d-md-block"], [1, "product-device", "product-device-2", "shadow-sm", "d-none", "d-md-block"], ["id", "search", 1, "container"], [1, "row"], [1, "col-md-6", "mx-auto"], ["id", "search_form", "onsubmit", "return false", 1, "col-lg-auto", "mb-3", "mb-lg-0", "me-lg-3"], ["type", "search", "id", "search", "placeholder", "Enter location", 1, "form-control", "form-control-dark"], ["id", "search_error", 1, "form-text", "text-muted"], [1, "text-center", "mt-2"], ["type", "submit", 1, "btn", "btn-outline-danger", "me-2"], [1, "fas", "fa-search-location"], ["id", "land", 1, "container"], [1, "card", "text-center", "mt-4", 2, "border-style", "none"], [1, "card-body"], [1, "row", "row-cols-1", "row-cols-md-3", "g-4"], [1, "col"], [1, "card", "shadow", "h-100"], ["src", "../../assets/images/house4.jpg", "height", "300", "alt", "...", 1, "card-img-top"], [1, "card-body", "text-muted"], [1, "card-title"], [1, "fas", "fa-map-marker-alt"], [2, "list-style", "none"], [1, "card-text"], [1, "fas", "fa-sitemap"], [1, "fas", "fa-arrows-alt"], [1, "fas", "fa-dollar-sign"], [1, "btn", "btn-danger", "w-50", 3, "routerLink"], [1, "fas", "fa-angle-double-right"], ["aria-label", "Page navigation example", 1, "mt-3"], [1, "pagination", "justify-content-center"], [1, "page-item"], ["href", "#", 1, "page-link", "text-danger"]], template: function LandComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](34, "\u00A0Size 0.05Ha");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](37, "\u00A0Dimension 100m by 500m");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/* harmony import */ var _recover_password_recover_password_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./recover-password/recover-password.component */ "9yQq");
...
/* harmony import */ var _detail_detail_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./detail/detail.component */ "rU/F");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _land_land_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./land/land.component */ "W9rS");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_16__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"],
        ...
        _recover_password_recover_password_component__WEBPACK_IMPORTED_MODULE_10__["RecoverPasswordComponent"],
        ...
        _land_land_component__WEBPACK_IMPORTED_MODULE_14__["LandComponent"],
        _settings_settings_component__WEBPACK_IMPORTED_MODULE_15__["SettingsComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_13__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_13__["ReactiveFormsModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClientModule"]] }); })();
...
class AuthService {
    ...
    registerUser(data) {
        return this.http.post(_constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].API_ENDPOINT + "user", data, { responseType: "text" });
    }
    requestReset(email) {
        return this.http.post(_constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].API_ENDPOINT + "reset/request", email, { responseType: "text" });
    }
    changePassword(data) {
        return this.http.post(_constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].API_ENDPOINT + "reset/finish", data, { responseType: "text" });
    }
    saveUser(user) {
...
FooterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FooterComponent, selectors: [["app-footer"]], decls: 60, vars: 0, consts: [[1, "container", "pt-4", "my-md-5", "pt-md-5"], [1, "row"], [1, "col-12", "col-md"], ["src", "", "alt", "logo image", "width", "24", "height", "19", 1, "mb-2"], [1, "d-block", "mb-3", "text-muted"], [1, "col-6", "col-md"], [1, "text-danger"], [1, "list-unstyled", "text-small"], [1, "mb-1"], ["href", "#", 1, "link-secondary", "text-decoration-none"]], template: function FooterComponent_Template(rf, ctx) { if (rf & 1) {
...
const _c0 = function () { return ["/lands", 2]; };
...
DetailComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DetailComponent, selectors: [["app-detail"]], decls: 59, vars: 2, consts: [[1, "container"], [1, "card", "my-3", "shadow", "h-100", 2, "border-style", "none"], [1, "row", "g-0"], [1, "col-md-6"], ["src", "../../assets/images/house4.jpg", "height", "700", "width", "700", "alt", "...", 1, "img-fluid"], [1, "card-body"], [1, "card-title", "text-muted"], [1, "card-text", "text-muted"], [1, "card-text"], [1, "text-muted"], [1, "col-9", "mx-auto"], ["id", "nav-tab", "role", "tablist", 1, "nav", "nav-tabs"], ["id", "nav-home-tab", "data-bs-toggle", "tab", "data-bs-target", "#nav-home", "type", "button", "role", "tab", "aria-controls", "nav-home", "aria-selected", "true", 1, "nav-link", "active", "text-danger"], ["id", "nav-profile-tab", "data-bs-toggle", "tab", "data-bs-target", "#nav-profile", "type", "button", "role", "tab", "aria-controls", "nav-profile", "aria-selected", "false", 1, "nav-link", "text-danger"], ["id", "nav-contact-tab", "data-bs-toggle", "tab", "data-bs-target", "#nav-contact", "type", "button", "role", "tab", "aria-controls", "nav-contact", "aria-selected", "false", 1, "nav-link", "text-danger"], ["id", "nav-tabContent", 1, "tab-content"], ["id", "nav-home", "role", "tabpanel", "aria-labelledby", "nav-home-tab", 1, "tab-pane", "fade", "show", "active"], ["id", "nav-profile", "role", "tabpanel", "aria-labelledby", "nav-profile-tab", 1, "tab-pane", "fade"], ["id", "nav-contact", "role", "tabpanel", "aria-labelledby", "nav-contact-tab", 1, "tab-pane", "fade"], [1, "text-danger", "text-center"], [1, "row", "row-cols-1", "row-cols-md-4", "g-4"], [1, "col"], [1, "card", "text-center", "h-100"], ["src", "../../assets/images/house4.jpg", "height", "300", "alt", "...", 1, "card-img-top"], [1, "card-body", "text-muted"], [1, "card-title"], [1, "fas", "fa-map-marker-alt"], [1, "fas", "fa-bed"], [1, "fas", "fa-shower"], [1, "fas", "fa-ruler-combined"], [1, "fas", "fa-dollar-sign"], [1, "btn", "btn-danger", "w-50", 3, "routerLink"], [1, "fas", "fa-angle-double-right"]], template: function DetailComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](50, "\u00A0bd ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](51, "i", 28);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](52, "\u00A0ba ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](53, "i", 29);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](54, "\u00A01175 sqft ");
...
/* harmony import */ var _land_land_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./land/land.component */ "W9rS");
/* harmony import */ var _listing_listing_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./listing/listing.component */ "0cUJ");
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./login/login.component */ "vtpD");
/* harmony import */ var _recover_password_recover_password_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./recover-password/recover-password.component */ "9yQq");
...
const _c0 = function () { return ["/recover-password"]; };
const _c1 = function () { return ["/register"]; };
class LoginComponent {
    // we will be using FormBuilder -> ReactiveFormsModule
    // wire -> in a constructor
    constructor(formBuilder, auth, tokenService) {
        this.formBuilder = formBuilder;
        this.auth = auth;
    ...
    login() {
        ...
        this.auth.getToken(this.loginData.value).subscribe((res) => {
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 27, vars: 5, consts: [[1, "container", "mt-4"], [1, "card", "bg-light", "shadow", "col-md-6", "mx-auto"], [1, "card-header", "bg-light"], [1, "text-danger", "text-center"], [1, "card-body"], ["id", "login_form", 1, "row", "g-3", 3, "formGroup", "ngSubmit"], [1, "col-md-12"], [1, "form-label"], ["formControlName", "email", "type", "text", "id", "email", "placeholder", "email@email.com", 1, "form-control"], ["id", "email_error", 1, "form-text", "text-muted"], ["formControlName", "password", "type", "password", "id", "password", "placeholder", "************", 1, "form-control"], ["id", "password_error", 1, "form-text", "text-muted"], [1, "col-12"], ["type", "submit", 1, "btn", "btn-outline-danger"], [1, "text-danger", 3, "routerLink"], [1, "card-footer", "bg-light"], [1, "text-muted"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](2, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](3, "h4", 3);
